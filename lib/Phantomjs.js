...
(function() {
  var ChildProcess, DEFAULT_PATH, EventEmitter, Phantomjs, _, expect, path, phantomjs,
  ...
  Phantomjs = (function(superClass) {
    ...
    Phantomjs.prototype.run = function(url, options, script, pipeClass, pipeClassOptions, useSystemPhantomjs) {
      var env, program, spawnArgs, spawnOptions;
      if (options == null) {
      ...
      this.childProcess.spawn(program, spawnArgs, spawnOptions, pipeClass, pipeClassOptions);
