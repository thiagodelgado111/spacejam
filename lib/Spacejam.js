...
(function() {
  var EventEmitter, Meteor, PhantomjsRunner, Spacejam, XunitFilePipe, expect, _,
  ...
  Spacejam = (function(_super) {
    ...
    Spacejam.prototype.testPackages = function(options) {
      ...
      if ((this.options.coverage != null) && this.options.coverage) {
        this.options['phantomjs-script'] = "phantomjs-test-in-console-with-coverage";
      }
      log.debug(this.options);
      try {
        this.meteor = new Meteor();
        this.phantomjs = new PhantomjsRunner();
      } catch (_error) {
        err = _error;
        console.trace(err);
        this.emit("done", 1);
