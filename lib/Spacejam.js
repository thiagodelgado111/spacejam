...
(function() {
  var EventEmitter, Meteor, Phantomjs, Spacejam, XunitFilePipe, _, expect,
  ...
  Spacejam = (function(superClass) {
    var instance;

    extend(Spacejam, superClass);
    ...
    function Spacejam() {
      this.onMeteorMongodbKillDone = bind(this.onMeteorMongodbKillDone, this);
      log.debug("Spacejam.constructor()");
    }

    Spacejam.prototype.runTests = function(command, options) {
      var err, error, error1, ref, ref1, ref2, ref3, ref4, ref5, ref6;
      if (options == null) {
        options = {};
      }
      ...
      if ((this.options.coverage != null) && this.options.coverage) {
        this.options['phantomjs-script'] = "phantomjs-test-in-console-with-coverage.js";
        if (this.options.coverage.length > 0) {
          process.env.COVERAGE_IN_COVERAGE = (ref = this.options.coverage.indexOf('in_coverage') > -1) != null ? ref : {
            "true": false
          };
          process.env.COVERAGE_OUT_COVERAGE = (ref1 = this.options.coverage.indexOf('out_coverage') > -1) != null ? ref1 : {
            "true": false
          };
          process.env.COVERAGE_OUT_LCOVONLY = (ref2 = this.options.coverage.indexOf('out_lcovonly') > -1) != null ? ref2 : {
            "true": false
          };
          process.env.COVERAGE_OUT_HTML = (ref3 = this.options.coverage.indexOf('out_html') > -1) != null ? ref3 : {
            "true": false
          };
          process.env.COVERAGE_OUT_JSON = (ref4 = this.options.coverage.indexOf('out_json_report') > -1) != null ? ref4 : {
            "true": false
          };
          process.env.COVERAGE_OUT_TEAMCITY = (ref5 = this.options.coverage.indexOf('out_teamcity') > -1) != null ? ref5 : {
            "true": false
          };
          process.env.COVERAGE_OUT_JSON_SUMMARY = (ref6 = this.options.coverage.indexOf('out_json_summary') > -1) != null ? ref6 : {
            "true": false
          };
        } else {
    ...
    Spacejam.prototype.killChildren = function(code) {
      ...
      if (!this.childrenKilled) {
        if ((ref = this.meteor) != null) {
          ref.kill();
        }
        if ((ref1 = this.phantomjs) != null) {
          ref1.kill();
        }
      }
    ...
    Spacejam.prototype.done = function(code) {
      ...
      this.waitForMeteorMongodbKillDone = (ref = this.meteor) != null ? ref.hasMongodb() : void 0;
